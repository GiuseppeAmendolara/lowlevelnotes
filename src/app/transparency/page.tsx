    ...
    <main className="min-h-screen bg-[#171717]">
      <section className="mx-auto max-w-3xl px-6 pb-24 pt-20 sm:pt-28">
        ...
        <div className="mt-10 flex max-w-[440px] flex-col gap-3">
          <SvgBadge src="/api/status.svg" alt="0xLLN API status" unavailableLabel="Status unavailable" />
          <SvgBadge src="/api/history.svg" alt="0xLLN API uptime history" unavailableLabel="History unavailable" />
          <SvgBadge src="/api/stats.svg" alt="0xLLN library stats" unavailableLabel="Stats unavailable" />
        </div>
      </section>
    </main>
  )
