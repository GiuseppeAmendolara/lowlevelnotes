...
// Replaces what used to be a full page of stacked link-cards (one grid per
// role tier) with a persistent sidebar, shared across every /account/*
// route via this layout — a staff member with every role tier no longer
// scrolls through six card-grids to find one link, and every nested page
// (profile, courses, staff, approvals) drops its own back-link and page
// chrome in favor of this one shared frame.
