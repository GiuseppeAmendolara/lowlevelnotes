              ...
              {user ? (
                ...
                >
                  {user.avatarUrl ? (
                    ...
                    <img src={getAssetSrc(user.avatarUrl)} alt="" className="h-5 w-5 shrink-0 border border-[#FF7A33] object-cover" />
                  ) : (
                    <span aria-hidden="true" className="flex h-5 w-5 shrink-0 items-center justify-center border border-[#FF7A33] bg-white/10 text-[9px] font-bold normal-case text-white/60">
